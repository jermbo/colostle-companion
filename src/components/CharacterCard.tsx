	...
	return (
		<div className="bg-base-200 relative overflow-hidden rounded-lg p-6 shadow-lg">
			<div className="absolute top-4 right-4">
				<Link to={`/characters/${slug}/menu`} className="text-base-content/60 hover:text-base-content">
			...
			<div className="mt-4">
				<Link to={`/characters/${slug}`} className="text-primary hover:text-primary-focus text-sm">
					Continue Journey →
				</Link>
			</div>
		</div>
