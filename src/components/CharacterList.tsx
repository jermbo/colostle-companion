...
const CharacterList = ({ characters, onContinue, onMenuClick }: Props) => {
	return (
		<div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
			<h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Your Characters</h2>

			{/* Horizontal scroll container */}
			<div className="relative">
				{/* Gradient fade effect for scroll indication */}
				<div className="pointer-events-none absolute top-0 right-0 z-10 h-full w-24 bg-gradient-to-l from-white dark:from-gray-900" />
